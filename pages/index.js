                ...
                <div className="my-6 flex flex-col px-2 md:px-36 lg:px-72">
                    <div className="bg-white flex flex-col w-full border rounded-lg shadow-lg p-4">
                                ...
                                <div className="flex flex-col justify-between mt-4 w-full rounded py-2 px-4 bg-gray-100">
                                    ...
                                    <div className="flex justify-between w-full items-end mt-4">
                                        ...
                                        <div className="flex w-2/12 ml-6">
                                            <button className="bg-gray-300 rounded-md py-2 px-8 text-sm">Beli</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between mt-4">
                            <div className="bg-gray-200 rounded-xl w-40 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-60 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-40 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-100 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-50 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-60 h-10"></div>
                            <div className="bg-gray-200 rounded-xl w-60 h-10"></div>
                        </div> 
                    </div>
                    ...
                    <div className="grid grid-cols-6 gap-4">
                        <Link href="/kategori">
                            <div className="bg-gray-200 rounded-lg h-40 flex justify-center items-center">
                                <a className="font-bold">Elektronik</a>
                            </div>
                        </Link>
                        <div className="bg-gray-200 rounded-lg h-40 flex justify-center items-center">
